...
public interface BookmarkMapper {
     ...
     */
    List<BookMark> getBookmarkListByUser(long userNumber);
     ...
     */
    int checkBookmarkExists(@Param("userNumber") long userNumber,
     ...
     */
    void deleteBookmark(@Param("userNumber") long userNumber,
                        @Param("storeId")    long storeId);
}