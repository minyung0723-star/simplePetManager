...
public class MyPageApiController {
    ...
    public ResponseEntity<Map<String, Object>> changePassword(
        ...
        // changePassword 서비스에서 이메일로 유저를 다시 조회하므로 userEmail도 함께 전달
        body.put("userNumber", user.getUserNumber());
    ...
    public ResponseEntity<Map<String, Object>> withdraw(
        ...
        // withdraw 서비스에서 비밀번호 확인 시 이메일로 유저를 다시 조회하므로 userEmail도 함께 전달
        body.put("userNumber", user.getUserNumber());
        body.put("userEmail",  user.getUserEmail());
        ...
        if (Boolean.TRUE.equals(withdrawResult.get("success"))) {
            ...
            cookieUtil.remove(response, "refresh_token");
        }
