...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/header_design.css?v=1.4">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/findUser.css?v=1.4">
</head>
<body>
